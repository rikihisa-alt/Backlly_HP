...
export const siteContent: SiteContent = {
  ...
  caseStudies: [
    {
      client: "訪問看護事業者",
      industry: "医療・ヘルスケア",
      challenge: "記録やスケジュール管理がExcelと紙で属人化し、情報共有に時間がかかっていた",
      support: "業務フロー整理＋B-Hallによる一元管理システム導入",
      result: "月間工数30%削減、情報共有の一元化を実現",
      description: "業務フロー整理＋システム導入",
    },
    {
      client: "スタートアップ企業",
      industry: "IT・テクノロジー",
      challenge: "急成長に伴いバックオフィス業務が追いつかず、意思決定に必要な情報が分散していた",
      support: "バックオフィス全体の業務棚卸し・フロー再設計・役割整理",
      result: "業務の可視化と役割整理により意思決定速度が2倍に向上",
      description: "バックオフィス全体の再設計",
    },
    {
      client: "介護事業者",
      industry: "福祉・介護",
      challenge: "複数拠点で管理方法がバラバラ、報告ミスや確認漏れが頻発していた",
      support: "複数拠点の管理体制構築＋B-Core開発による統合管理システム",
  ...
  companyInfo: {
    ...
    businessDescription: "バックオフィス業務の整理・設計・システム化を一貫して支援する企業です。業務コンサルティングから、自社プロダクト「B-Hall」の提供、企業専用システム「B-Core」の開発まで、課題に合わせた最適な支援体制を構築します。",
    supportStructure: "専任の担当者がヒアリングから運用まで一貫して対応。外部パートナーへの丸投げはせず、すべて自社チームで設計・開発を行います。",
    scope: "業務整理 / フロー設計 / システム導入 / カスタム開発 / 運用保守 / DX支援",
    responseTime: "お問い合わせから原則1営業日以内にご返信いたします。",
  },
  faq: [
    {
      question: "どの段階から相談できますか？",
      answer: "初期の整理段階から対応可能です。「何から手をつければいいかわからない」という状態でも、まずはヒアリングで現状を整理するところから始められます。",
    },
    {
      question: "小規模な会社でも依頼できますか？",
      answer: "可能です。規模に応じて最適な設計を行います。5名以下の企業さまへの支援実績もございます。",
    },
    {
      question: "システム開発だけ依頼できますか？",
      answer: "可能ですが、業務整理からの実施を推奨しています。整理されていない業務をそのままシステム化すると、かえって複雑化する場合があるためです。",
    },
    {
      question: "期間はどれくらいですか？",
      answer: "業務整理は数週間〜1ヶ月程度、システム開発は規模に応じて2〜6ヶ月が目安です。段階的な導入も可能です。",
    },
    {
      question: "費用はどのくらいですか？",
      answer: "内容に応じて個別見積となります。初回相談は無料ですので、まずはお気軽にご相談ください。概算シミュレーションもご用意しております。",
    },
    {
      question: "地方からでも依頼できますか？",
      answer: "はい、全国対応しております。オンラインでのヒアリング・打ち合わせが可能です。",
    },
    {
      question: "既存のシステムとの連携は可能ですか？",
      answer: "可能です。既存の業務ツールやシステムとの連携を前提に設計を行います。まずは現状の環境をヒアリングさせてください。",
    },
    {
      question: "導入後のサポートはありますか？",
      answer: "はい。運用保守プランをご用意しており、導入後の改善・追加開発・問い合わせ対応まで継続的にサポートいたします。",
    },
  ],
  cta: {
    headline: "まずは整理から。",
  ...
  consultTopics: [
    {
      title: "業務整理",
      description: "何から手をつければいいかわからない、業務が属人化している、などの初期段階からご相談いただけます。",
    },
    {
      title: "システム化の可否",
      description: "今の業務をシステム化すべきか、どこまで自動化できるか、費用対効果を含めて判断をお手伝いします。",
    },
    {
      title: "改善提案",
      description: "現状の業務フローを分析し、具体的な改善案と優先順位をご提案します。",
    },
  ],
};
